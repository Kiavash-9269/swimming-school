...
export default function Footer() {
    return (
        <footer className="bg-[#D6E8F1] py-16 mt-40 flex justify-center" dir="rtl">
            <div className="w-full max-w-[1280px] px-6 flex flex-col lg:flex-row gap-10">
                {/* ----- Logo & Info ----- */}
                <div className="relative lg:flex-1 text-center w-full h-[270px] ">
                    <div className="absolute left-1/2 -top-20 -translate-x-1/2 bg-[#132238] text-white p-10 w-full max-w-sm rounded-lg w-full">
