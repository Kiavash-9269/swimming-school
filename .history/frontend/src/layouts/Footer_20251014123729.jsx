            ...
            <div className='relative w-full maxw'>
                ...
                <div className="bg-[#132238] p-10 px-15 flex flex-col text-center absolute -top-20 text-white">
                    <div className="flex items-center justify-center w-full gap-x-2">
                        <Link to=''>
                            <img src={logo} alt="Iran Australia Swimming School Logo" className='h-12 w-12 drop-shadow-md transition-all duration-300 hover:scale-110 hover:rotate-6'></img>
                        </Link>
