    ...
    return (
        <div className="w-full flex flex-col lg:flex-row bg-[#D6E8F1] px-5 py-10 mt-40 pb-80 ">
            ...
            <div className='relative w-full h-[240px]'>
                ...
                <div className="absolute left-1/2 -top-20 transform -translate-x-1/2 bg-[#132238] p-10 px-15 flex flex-col text-center text-white h-[300px] w-full md:max-w-[500px] lg:max-w-">
