    ...
    return (
        <footer className="bg-[#D6E8F1] py-16 mt-40 flex justify-center" dir="rtl">
            <div className="w-full max-w-[1280px] px-6 flex flex-col lg:flex-row gap-10">
                {/* ----- Logo & Info ----- */}
                <div className="relative lg:flex-1 text-center w-full h-[150px] ">
                    <div className="absolute left-1/2 -top-25 -translate-x-1/2 bg-[#132238] text-white p-10 py-1.5 w-full rounded-lg ">
