    ...
    return (
        <div className="w-full flex bg-[#D6E8F1] px-5 py-10 mt-40 pb-80">
            ...
            <div className='relative w-full maxw'>
                ...
                <div className="bg-gradient-to-br from-[#9400D3] to-[#4B0082] bg-[length:400%_400%] animate-gradient-normal
 p-10 px-15 flex flex-col text-center absolute -top-20 text-white">
