...
export default function Footer() {
    ...
    return (
        <section className='flex justify-center bg-[#D6E8F1] mt-40' >
            <div className="w-full flex flex-col lg:flex-row gap-x-10 gap-y-5 px-5 py-10 max-w-[1200px] ">
                ...
                <div className='flex flex-col md:flex-row w-full lg:pt-5 gap-x-10'>

                    <div className='flex flex-col text-right md:w-fit'>
                    ...
                    <div className='flex flex-col text-right md:w-1/4'>
                    ...
                    <div className='flex flex-col w-full md:w-2/4'>
                        ...
                        <p className='pt-3 text-gray-700'>با عضویت در خبرنامه، از جدیدترین تخفیف‌ها، دوره‌های آموزشی و اطلاعیه‌های مهم زودتر از سایرین باخبر شوید</p>
                     
                        <form class="flex bg-white rounded-full overflow-hidden shadow-sm mt-5">
                            <input
                                type="email"
                                placeholder="ایمیلتان را وارد کنید"
                                class="flex-1 px-4 py-5 text-sm text-gray-700 focus:outline-none"
                                required
                            />
                            <button
                                type="submit"
