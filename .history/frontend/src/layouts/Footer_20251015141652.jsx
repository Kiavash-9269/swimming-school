...
export default function Footer() {
    ...
    return (
        <section className='flex justify-center bg-[#D6E8F1] mt-40' >
            <div className="w-full flex flex-col lg:flex-row gap-x-15 px-5 py-10 max-w-[1200px] ">
      ...
      ps-0                       <a href="#" className="p-3 hover:bg-blue-500 transition-all duration-300 border border-sky-900 fill-white">
      ...
      ps-0                       <a href="#" className="p-3 hover:bg-blue-500 transition-all duration-300 border border-sky-900 fill-white">
                ...
                <div className='flex w-full lg:w-1/6 lg:pt-5'>
                ...
                <div className='flex w-full lg:w-1/5 lg:pt-5'>
                    <div className='flex flex-col text-right'>
