            ...
            <div className="w-full flex flex-col lg:flex-row gap-x-10 gap-y-5 px-5 py-10 max-w-[1280px] ">
                ...
                <div className='flex flex-col md:flex-row w-full lg:pt-5 gap-x-5'>
                    ...
                    <div className='flex flex-col w-full md:w-4/10'>
                        ...
                        <p className='pt-3 text-gray-600 text-sm leading'>با عضویت در خبرنامه، از جدیدترین تخفیف‌ها، دوره‌های آموزشی و اطلاعیه‌های مهم زودتر از سایرین باخبر شوید</p>
