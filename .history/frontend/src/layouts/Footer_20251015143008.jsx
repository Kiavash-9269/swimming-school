        ...
        <section className='flex justify-center bg-[#D6E8F1] mt-40' >
            <div className="w-full flex flex-col lg:flex-row  gap-y-5 px-5 py-10 max-w-[1200px] ">
                ...
                <div className='flex flex-col md:flex-row w-full lg:pt-5 '>
                    ...
                    <div className='flex flex-col w-full md:w-2/4'>پ
                        <h3 className='mb-3 text-lg font-bold'>اولین نفر از اخبار ویژه مطلع شوید</h3>
                        <p className=''>با عضویت در خبرنامه، از جدیدترین تخفیف‌ها، دوره‌های آموزشی و اطلاعیه‌های مهم زودتر از سایرین باخبر شوید</p>
                    </div>
