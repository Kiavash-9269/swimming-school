...
export default function Footer() {
    ...
    return (
        <section className='flex justify-center bg-[#D6E8F1] mt-40 dir="rtl"' >
            <div className="w-full flex flex-col lg:flex-row gap-x-10 gap-y-5 px-5 py-10 max-w-[1280px] ">

                <div className='relative w-full h-[240px] md:max-w-[500px] lg:max-w-1/3'>

                    <div className="absolute left-1/2 -top-20 transform -translate-x-1/2 bg-[#132238] p-10 px-15 flex flex-col text-center text-white h-[300px] w-full ">
                ...
                <div className='flex flex-col md:flex-row w-full lg:pt-5 gap-x-5 xl:gap-x-0'>

                    <div className='flex flex-col text-right md:w-3/10'>
                        <h3 className='mb-3 text-lg font-bold'>لینک های کاربردی</h3>
                        <ul className='flex flex-col w-full text-gray-600'>
                            <li className='w-full'>
                                <a className='w-full p-3 ps-0 flex items-center gap-x-2 transition-colors duration-300 hover:text-teal-600 cursor-pointer'>
                    ...
                    <div className='flex flex-col text-right md:w-3/10'>
                        <h3 className='mb-3 text-lg font-bold'>پشتیبانی و قوانین سایت</h3>
                        <ul className='flex flex-col w-full text-gray-600'>
                    ...
                    <div className='flex flex-col w-full md:w-4/10'>
                        <h3 className='mb-3 text-lg font-bold'>اولین نفر از اخبار ویژه مطلع شوید</h3>
                        <p className='pt-3 text-gray-600 text-sm leading-relaxed'>با عضویت در خبرنامه، از جدیدترین تخفیف‌ها، دوره‌های آموزشی و اطلاعیه‌های مهم زودتر از سایرین باخبر شوید</p>

                        <form class="flex bg-white rounded-full overflow-hidden shadow-sm mt-5">
                            <input
                                type="email"
                                placeholder="ایمیلتان را وارد کنید"
                                class="flex-1 px-4 py-5 text-sm text-gray-600 focus:outline-none"
                                required
                            />
                            <button
                                type="submit"
                                class="bg-blue-500 hover:bg-blue-600 text-white px-6 text-sm font-medium rounded-full"
                            >
                                عضویت
                            </button>
                        </form>
