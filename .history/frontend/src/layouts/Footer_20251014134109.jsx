            ...
            <div className='relative w-full maxw'>
                ...
                <div className="bg-[#132238] p-10 px-15 flex flex-col text-center absolute -top-20 text-white">
                    ...
                    <div className="flex justify-center items-center w-full">
                        <a href="#" className="p-2.5 hover:bg-blue-500 transition-all duration-300 border text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" width="15px" height="20px" viewBox="0 0 24 24" fill="currentColor">
