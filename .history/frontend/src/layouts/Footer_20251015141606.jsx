...
export default function Footer() {
    ...
    return (
      ...
      ps                       <a href="#" className="p-3 hover:bg-blue-500 transition-all duration-300 border border-sky-900 fill-white">
                ...
                <div className='flex w-full lg:w-1/6 lg:pt-5'>
                    <div className='flex flex-col text-right'>
                        ...
                        <ul className='flex flex-col w-full'>
                            <li className='w-full'> 
                                <a className='w-full p-3 ps flex items-center gap-x-2 transition-colors duration-300 hover:text-teal-600 cursor-pointer'>
