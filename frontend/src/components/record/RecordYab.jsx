...
export default function SwimmingPerformancePro() {
  ...
  const records = [
    ...
    {
      event: "50m پروانه ایران",
      time: 24.15,
      distance: 50,
      holder: "مهردشاد افقری",
      type: "داخلی",
      discipline: "پروانه",
    },
    {
      event: "100m پروانه ایران",
      time: 53.32,
      distance: 100,
      holder: "مهردشاد افقری",
      type: "داخلی",
    ...
    },
    {
      ...
      time: 126.0,
      distance: 200,
      holder: "Anton Chupkov",
      type: "خارجی",
      discipline: "غورباقه",
    },

    {
      event: "50m غورباقه ایران",
      time: 27.95,
      distance: 50,
      holder: "محمد علیرضایی دریزچه",
      type: "داخلی",
      discipline: "غورباقه",
    },
    {
      event: "100m غورباقه ایران",
      time: 62.12,
      distance: 100,
      holder: "امیر مطاعی",
      type: "داخلی",
  ...
  return (
    <div
      dir="rtl"
      className="min-h-screen bg-sky-950 p-3 sm:p-6 flex flex-col items-center"
    >
                  ...
                  <div className="flex flex-wrap justify-center gap-3 sm:gap-6 text-gray-800">
                    ...
                    <div className="flex flex-col items-center bg-white/70 px-3 py-2 sm:px-4 sm:py-3 rounded-xl shadow-sm min-w-[100px] sm:min-w-[120px]">
                      ...
                      <span className="font-normal text-base sm:text-lg text-blue-700">
                        {records.find((r) => r.event === selectedEvent).time}{" "}
                        ثانیه
                      </span>
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    ...
                    <div className="p-3 sm:p-4 rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 shadow-sm border border-blue-200 text-right">
                      ...
                      {results.world.exists ? (
                        ...
                        <div className="text-xs sm:text-sm text-gray-600 text-justify">
                          {results.world.message}
                        </div>
                      )}
                    </div>
                          ...
                          <ResponsiveContainer width="100%" height="100%">
                            <PieChart>
                              <Pie
                                ...
                                stroke="none"
                              >
                                {chartDataFor(results.world.performance).map(
                                  (entry, index) => (
                          ...
                          <ResponsiveContainer width="100%" height="100%">
                            <PieChart>
                              <Pie
                                ...
                                stroke="none"
                              >
                                {chartDataFor(results.national.performance).map(
                                  (entry, index) => (
                                    <Cell
                                      key={index}
                                      fill={COLORS_NAT[index]}
                                    />
                                  ),
                                )}
                              </Pie>
                  ...
                  <div className="bg-gradient-to-bl from-blue-100 to-sky-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 space-y-3 sm:space-y-4 shadow-sm border border-blue-200 text-right">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                      <div className="flex flex-col p-3 sm:p-4 bg-white rounded-xl shadow-sm border border-blue-100 text-center">
                        <span className="text-gray-600 text-xs sm:text-sm mb-1 sm:mb-2">
                          زمان شما
                        </span>
                        <span className="font-bold text-blue-700 text-lg sm:text-xl">
                          {results.swimmerTime} ثانیه
                        </span>
                      </div>
                      ...
                      <div className="text-yellow-800 space-y-3 sm:space-y-4 text-xs sm:text-sm leading-relaxed">
                        <div>
                          ...
                          <p className="text-justify">
                            این سیستم توسط فدراسیون جهانی شنا (World Aquatics)
                            طراحی شده تا عملکرد شناگران را در مواد مختلف به‌صورت
                            عادلانه مقایسه کند.
                          </p>
                        </div>
                        ...
                        <div>
                          <p className="font-bold text-yellow-900 mb-2 sm:mb-3">
                            تفسیر امتیازها:
                          </p>
                          <ul className="list-disc list-inside space-y-1 sm:space-y-2 pr-3 sm:pr-4 text-justify">
                            <li>
                              <strong className="ml-1">۱۰۰۰ امتیاز:</strong>{" "}
                              برابر با رکورد جهانی
                            </li>
                            <li>
                            ...
                            <li>
                              <strong className="ml-1">۸۰۰-۸۹۹ امتیاز:</strong>{" "}
                              عملکرد در سطح قهرمانی
                            </li>
                            <li>
                              <strong className="ml-1">۷۰۰-۷۹۹ امتیاز:</strong>{" "}
                              عملکرد خوب
                            </li>
                            <li>
                              <strong className="ml-1">۶۰۰-۶۹۹ امتیاز:</strong>{" "}
                              عملکرد متوسط
                            </li>
                            <li>
                              <strong className="ml-1">زیر ۶۰۰ امتیاز:</strong>{" "}
                        ...
                        <p className="text-xs mt-3 sm:mt-4 text-yellow-700 bg-yellow-100 border border-yellow-200 rounded-lg p-2 sm:p-3 text-center">
                          این سیستم کمک می‌کند عملکرد شناگران در رشته‌ها و
                          مسافت‌های متفاوت به‌صورت منصفانه مقایسه شود.
                        </p>
                      </div>
                    </div>
                  )}
              ...
              <div className="bg-white overflow-x-auto rounded-xl border border-gray-200 shadow-xs sm:shadow-2xs">
                <table className="w-full border-collapse min-w-[640px]">
                  <thead className="bg-gradient-to-r from-blue-500 to-blue-600 text-white">
                    <tr>
                      <th className="border-b p-2 sm:p-3 text-center font-semibold text-xs sm:text-sm">
                        رشته
                      </th>
                      <th className="border-b p-2 sm:p-3 text-center font-semibold text-xs sm:text-sm">
                        رکورد (ثانیه)
                  ...
                  <tbody>
                    {filteredRecords.map((r) => (
                      ...
                      >
                        <td className="border-b p-2 sm:p-3 font-medium">
                          {r.event}
                        </td>
