  ...
  const services = [
    {
      ...
      details: "ما در این مجموعه دوره‌های آموزشی شنا را در سطوح مبتدی، متوسط و پیشرفته برگزار می‌کنیم. کودکان از سن ۴ سال به بالا می‌توانند در کلاس‌های ویژه کودکان شرکت کنند. دوره‌های بزرگسالان نیز شامل تکنیک‌های کرال سینه، کرال پشت، قورباغه و پروانه می‌شود. تمامی مربیان دارای مدرک بین‌المللی و کارت صلاحیت حرفه‌ای از فدراسیون شنا هستند. هر ترم ۱۲ جلسه یک‌ساعته برگزار می‌شود و در پایان به هنرجویان گواهی معتبر اعطا می‌گردد."
    },
    {
      id: 2,
      icon: Waves,
